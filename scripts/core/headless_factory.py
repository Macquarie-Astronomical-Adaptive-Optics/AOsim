...
def run_headless_longrun(
    ...
    *,
    ...
    keys include:
        ...
        control_bundle_include_matrices, control_bundle_include_gram, progress_every.
    """
    ...
    result = runner.run(
        ...
        control_bundle_include_gram=bool(cfg.get("control_bundle_include_gram", False)),
        control_bundle_gram_chunk_modes=int(cfg.get("control_bundle_gram_chunk_modes", 64)),
